  ...
  return (
    <div className="min-h-screen bg-slate-950 p-6 md:p-10 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto z-10 relative">
        {/* Navigation Bar */}
        <header className="bg-slate-900/40 backdrop-blur-md border border-slate-800/80 rounded-3xl px-6 py-4 flex items-center justify-between mb-8 shadow-xl">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent tracking-tight">
              My Journal
            </h1>
          </div>
          ...
          <div className="flex gap-3">
            <Link
              to="/create"
              className="bg-indigo-600 hover:bg-indigo-500 text-white px-5 py-2.5 rounded-2xl font-semibold transition-all duration-300 shadow-lg shadow-indigo-600/10 hover:shadow-indigo-600/20 flex items-center gap-2"
            >
            ...
            <button
              ...
              className="bg-slate-800/80 hover:bg-slate-700/80 text-slate-300 hover:text-white px-5 py-2.5 rounded-2xl font-semibold transition duration-300 border border-slate-700/50 flex items-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
          <div className="lg:col-span-2 bg-gradient-to-r from-slate-900 to-indigo-950 border border-slate-800 p-8 rounded-3xl shadow-xl flex flex-col justify-between">
            <div>
              <span className="text-indigo-400 text-sm font-semibold uppercase tracking-wider">Dashboard</span>
              <h2 className="text-4xl font-extrabold text-white mt-2 leading-tight">
                Hello, {userName}!
              </h2>
